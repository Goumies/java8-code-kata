...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (firstAge, secondAge) -> Integer.compare(secondAge, firstAge);
    ...
    public void top3RichCustomer() {
        ...
        Stream<String> top3RichCustomerStream = customerList.stream()
                .filter(customer -> customer.getBudget() > 1000)
                .sorted((firstCustomer, secondCustomer) -> Integer.compare(secondCustomer.getBudget(), firstCustomer.getBudget()))
